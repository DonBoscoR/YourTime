...
public class YourTimeRestURIConstants {
	...
	public static class UsersWS{
		...
		public static final String WS_USER_AUTHENDICATE = "/users/authenticate";
		...
		public static final String WS_USER_REQUEST_FEEDBACK_ON_APPOINTMENT = "/users/feedback/appointment";
	}
